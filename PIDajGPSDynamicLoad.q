...
/comment out these variables and declare them during runtime to allow for dynamic load
directory: "../../tensorflow/"
logName: "train_020319_LOG00049_56_58_59"

/ \ts GPSData: ("f",(7-1)#"f";enlist csv) 0: `$directory,logName,"GPS.csv"
/ \ts PIDData: ("ff",(32-2)#"f";enlist csv) 0: `$directory,logName,".csv"
...
/the 1st 'first' argument gets first row from table (read from right)
